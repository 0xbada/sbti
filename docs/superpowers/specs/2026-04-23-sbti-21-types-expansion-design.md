...
## 7. Phase 1 좌표 테이블 (2026-04-23 구현 세션 작성)

### 21유형 좌표 테이블

| # | code | nameKo | tagline | rarity | archetype_family |
|---|---|---|---|---|---|
| 1 | FUCK | 빡침러 | 입이 먼저 나가고 생각은 나중에 도착하지 | common | 직설 팩폭 |
| 2 | SHIT | 투덜이 | 입은 불평, 손은 엑셀, 결국 해내는 사람 | common | 직설 팩폭 |
| 3 | POOR | 짠돌이 | 짠내와 집중은 한 끗 차이야 | common | 직설 팩폭 |
| 4 | ATM-er | 호구파 | 내가 살게, 근데 내 지갑은 왜 늘 울고 있지 | common | 자조 루저 |
| 5 | SOLO | 혼자족 | 혼자가 편한 게 아니라, 상처가 덜한 거지 | common | 자조 루저 |
| 6 | IMSB | 자책뇌 | 내 탓부터 한 번 돌려보자, 또 돌려보자 | common | 자조 루저 |
| 7 | IMFW | 순두부 | 한 마디 다정함에 전 재산을 거는 타입 | common | 자조 루저 |
| 8 | ZZZZ | 잠수러 | 쌓인 카톡 99+개, 마감 2시간 전 — 일단 다 나중에 | common | 자조 루저 |
| 9 | OH-NO | 걱정뇌 | 일어나지 않은 일의 n가지 버전을 상상 완료 | common | 자조 루저 |
| 10 | BOSS | 결정왕 | 누가 안 나서면 어쩔 수 없이 내가 나선다 | common | 허세 과시 |
| 11 | SEXY | 끼부자 | 누가 안 보면 나는 여전히 매력적인가 | common | 허세 과시 |
| 12 | GOGO | 돌진러 | 생각보다 몸이 먼저, 후회는 나중 | common | 허세 과시 |
| 13 | MUM | 엄마덜 | 다들 챙기느라 정작 나는 뒷전이 되는 사람 | rare | 따뜻함 |
| 14 | LOVE-R | 연애뇌 | 일상도 드라마로 편집하는 감정 필터 | common | 따뜻함 |
| 15 | THAN-K | 감사쟁이 | 작은 호의도 평생 빚처럼 갚고 싶어져 | common | 따뜻함 |
| 16 | THIN-K | 생각뇌 | 두 시간 고민하고 결국 안 살아 | rare | 사색 관찰 |
| 17 | JOKE-R | 광대러 | 드립으로 막으면 진심을 들킬 일이 없어 | common | 사색 관찰 |
| 18 | OJBK | 아무거나러 | 아무거나, 진짜로 아무거나 괜찮아 | common | 사색 관찰 |
| 19 | FAKE | 가면부자 | 상황별 자동 전환, 진짜 나는 어디 갔더라 | rare | 사색 관찰 |
| 20 | WOC! | 탄식왕 | '헐 대박' 뒤엔 이미 예상했다는 차분함 | rare | 사색 관찰 |
| 21 | Dior-s | 체념러 | 소비, 노력, 그딴 거 다 됐어 | rare | 사색 관찰 |

**rarity 분포:** rare 5 (MUM, THIN-K, FAKE, WOC!, Dior-s) + common 16 = 21.
**archetype_family 분포:** 직설 팩폭 3 / 자조 루저 6 / 허세 과시 3 / 따뜻함 3 / 사색 관찰 6 = 21.

### 15차원 프로필 (0.0~1.0, 21개 신규)

(축 약어: S=SELF, E=EMO, A=ATT, C=ACT, O=SOC)

| code | S_AWARE | S_ESTEEM | S_CTRL | E_EXPR | E_STAB | E_EMPATHY | A_OPTIM | A_CYNIC | A_REAL | C_DRIVE | C_DILIG | C_RISK | O_EXT | O_AGREE | O_CONFL |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| FUCK | 0.3 | 0.5 | 0.1 | 0.9 | 0.4 | 0.2 | 0.4 | 0.5 | 0.3 | 0.5 | 0.3 | 0.8 | 0.9 | 0.2 | 0.2 |
| SHIT | 0.8 | 0.7 | 0.7 | 0.7 | 0.5 | 0.2 | 0.1 | 0.9 | 0.8 | 0.8 | 0.7 | 0.4 | 0.2 | 0.3 | 0.4 |
| POOR | 0.8 | 0.6 | 0.7 | 0.2 | 0.6 | 0.3 | 0.2 | 0.6 | 0.8 | 0.8 | 0.8 | 0.3 | 0.2 | 0.3 | 0.4 |
| ATM-er | 0.5 | 0.2 | 0.2 | 0.6 | 0.4 | 0.8 | 0.5 | 0.4 | 0.4 | 0.5 | 0.7 | 0.4 | 0.6 | 0.9 | 0.5 |
| SOLO | 0.8 | 0.3 | 0.9 | 0.3 | 0.5 | 0.2 | 0.3 | 0.6 | 0.7 | 0.2 | 0.3 | 0.2 | 0.1 | 0.4 | 0.6 |
| IMSB | 0.9 | 0.1 | 0.5 | 0.4 | 0.2 | 0.8 | 0.2 | 0.7 | 0.4 | 0.4 | 0.6 | 0.2 | 0.3 | 0.7 | 0.7 |
| IMFW | 0.3 | 0.1 | 0.3 | 0.5 | 0.2 | 0.9 | 0.4 | 0.3 | 0.2 | 0.2 | 0.3 | 0.2 | 0.2 | 0.8 | 0.8 |
| ZZZZ | 0.7 | 0.4 | 0.4 | 0.2 | 0.6 | 0.3 | 0.2 | 0.6 | 0.5 | 0.1 | 0.1 | 0.4 | 0.1 | 0.4 | 0.8 |
| OH-NO | 0.8 | 0.4 | 0.7 | 0.4 | 0.1 | 0.5 | 0.1 | 0.9 | 0.7 | 0.6 | 0.8 | 0.2 | 0.2 | 0.4 | 0.7 |
| BOSS | 0.6 | 0.9 | 0.7 | 0.3 | 0.7 | 0.4 | 0.6 | 0.4 | 0.7 | 0.9 | 0.7 | 0.6 | 0.4 | 0.3 | 0.2 |
| SEXY | 0.5 | 0.9 | 0.4 | 0.8 | 0.6 | 0.3 | 0.7 | 0.3 | 0.5 | 0.7 | 0.5 | 0.6 | 0.9 | 0.3 | 0.3 |
| GOGO | 0.2 | 0.7 | 0.3 | 0.6 | 0.5 | 0.4 | 0.8 | 0.2 | 0.2 | 0.9 | 0.5 | 0.9 | 0.8 | 0.4 | 0.3 |
| MUM | 0.7 | 0.2 | 0.6 | 0.7 | 0.6 | 0.9 | 0.8 | 0.2 | 0.6 | 0.8 | 0.9 | 0.3 | 0.7 | 0.9 | 0.7 |
| LOVE-R | 0.2 | 0.4 | 0.3 | 0.9 | 0.2 | 0.8 | 0.9 | 0.2 | 0.3 | 0.5 | 0.4 | 0.6 | 0.6 | 0.7 | 0.3 |
| THAN-K | 0.8 | 0.3 | 0.7 | 0.3 | 0.5 | 0.8 | 0.5 | 0.3 | 0.5 | 0.4 | 0.6 | 0.2 | 0.3 | 0.8 | 0.8 |
| THIN-K | 0.9 | 0.5 | 0.7 | 0.3 | 0.3 | 0.5 | 0.3 | 0.8 | 0.6 | 0.2 | 0.5 | 0.1 | 0.2 | 0.4 | 0.6 |
| JOKE-R | 0.3 | 0.2 | 0.4 | 0.9 | 0.5 | 0.8 | 0.5 | 0.8 | 0.5 | 0.4 | 0.4 | 0.5 | 0.8 | 0.7 | 0.7 |
| OJBK | 0.7 | 0.6 | 0.4 | 0.2 | 0.9 | 0.3 | 0.3 | 0.5 | 0.8 | 0.2 | 0.4 | 0.3 | 0.3 | 0.5 | 0.6 |
| FAKE | 0.7 | 0.2 | 0.3 | 0.6 | 0.5 | 0.5 | 0.5 | 0.5 | 0.4 | 0.5 | 0.5 | 0.5 | 0.7 | 0.8 | 0.8 |
| WOC! | 0.6 | 0.8 | 0.5 | 0.9 | 0.8 | 0.2 | 0.5 | 0.6 | 0.6 | 0.4 | 0.5 | 0.4 | 0.7 | 0.5 | 0.5 |
| Dior-s | 0.8 | 0.7 | 0.7 | 0.2 | 0.8 | 0.3 | 0.2 | 0.8 | 0.8 | 0.3 | 0.8 | 0.2 | 0.2 | 0.4 | 0.7 |

### 검증 리포트 (`npm run validate` 출력)
...
================================================================
총 유형: 27 (일반 25 + 특수 2)
비교 쌍: 전체 351 / 일반 유형만 300
임계값: L2 ≥ 0.5 (일반 쌍에만 게이트 적용)

[최소 거리 top 10 (전체 쌍)]
   1. CTRL     ↔ BOSS     L2=0.559 ✅
   2. ATM-er   ↔ FAKE     L2=0.566 ✅
   3. SOLO     ↔ THIN-K   L2=0.574 ✅
   4. DRUNK    ↔ LOVE-R   L2=0.592 (info)
   5. MALO     ↔ OJBK     L2=0.632 ✅
   6. SHIT     ↔ POOR     L2=0.632 ✅
   7. OH-NO    ↔ THIN-K   L2=0.632 ✅
   8. HHHH     ↔ FAKE     L2=0.640 (info)
   9. OJBK     ↔ Dior-s   L2=0.656 ✅
  10. MALO     ↔ ZZZZ     L2=0.663 ✅
...
[각 유형의 최근접 (일반 유형 기준)]
  ...
  SHIT     → POOR     (L2=0.632)
  POOR     → SHIT     (L2=0.632)
  ATM-er   → FAKE     (L2=0.566)
  SOLO     → THIN-K   (L2=0.574)
  IMSB     → THAN-K   (L2=0.686)
  IMFW     → ATM-er   (L2=0.854)
  ZZZZ     → MALO     (L2=0.663)
  OH-NO    → THIN-K   (L2=0.632)
  BOSS     → CTRL     (L2=0.559)
  SEXY     → GOGO     (L2=0.678)
  GOGO     → SEXY     (L2=0.678)
  MUM      → ATM-er   (L2=0.787)
  LOVE-R   → ATM-er   (L2=0.831)
  THAN-K   → IMSB     (L2=0.686)
  THIN-K   → SOLO     (L2=0.574)
  JOKE-R   → FAKE     (L2=0.707)
  OJBK     → MALO     (L2=0.632)
  FAKE     → ATM-er   (L2=0.566)
  WOC!     → SEXY     (L2=0.693)
  Dior-s   → OJBK     (L2=0.656)

[슈퍼축 분포 (일반 유형)]
  SELF       자아 : min=0.13 max=0.85 std=0.18 ✅
  EMOTION    감정 : min=0.20 max=0.73 std=0.13 ✅
  ATTITUDE   태도 : min=0.30 max=0.63 std=0.08 ⚠️
  ACTION     행동 : min=0.05 max=0.77 std=0.19 ✅
  SOCIAL     사교 : min=0.30 max=0.77 std=0.14 ✅

✅ 통과 (일반 유형 300쌍 모두 L2 ≥ 0.5)
```

**검증 반복 기록:**
- 1차 시도: 5개 충돌 (ATM-er↔FAKE, SOLO↔Dior-s, THIN-K↔Dior-s, SOLO↔THIN-K, MONK↔OJBK)
- 수정 전략: 축 의미 기반 개념 차이축 재설정 (FAKE 표면 공감 vs ATM-er 실제 돌봄 / Dior-s 탈속 평정 강화 / THIN-K 불안정+몽상 보강 / OJBK 무관심 분리)
- 2차: 0 충돌, 최소 거리 L2=0.559 (CTRL↔BOSS)

**ATTITUDE std=0.08 경고:** 27유형 모두 ATT_OPTIM·ATT_CYNIC·ATT_REAL 중간 근처 집중. 극단 낙관/순수 유형 부재 — 한국 밈 시장의 자조/냉소 편향 반영. 설계 의도로 수용.
